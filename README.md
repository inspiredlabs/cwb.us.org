...
> 🗝️ Key question: Before each `CTA`, should we replace these with a cohesive, consistent `slogan`?
...
> 🗝️ Key question: can existing website [analytics](https://www.googletagmanager.com/gtag/js?id=UA-38080782-1) help us define which  `Devices` our `Target Audience` use?
